...
%%%%%%%%%%%%%%%%%%%%%%%%% TIEMPO %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tf=49.6;             % Tiempo de simulación en segundos (s)
...
v = [0*ones(1,10)      1*ones(1,30)    0*ones(1,10)     1*ones(1,35)     0*ones(1,10)       1*ones(1,30)   0*ones(1,10)      1*ones(1,35)    0*ones(1,10)      1*ones(1,41)     0*ones(1,10)        1*ones(1,65)     0*ones(1,10)       1*ones(1,30)   0*ones(1,10)         1*ones(1,15)   0*ones(1,10)      1*ones(1,25)   0*ones(1,10)    1*ones(1,25)   0*ones(1,10)         1*ones(1,15)   0*ones(1,10)      1*ones(1,31)]; % Velocidad lineal de referencia (m/s)
w = [-pi/2*ones(1,10)   0*ones(1,30)   pi/2*ones(1,10)  0*ones(1,35)    pi/2*ones(1,10)     0*ones(1,30)   -pi/2*ones(1,10)  0*ones(1,35)   -3*pi/4*ones(1,10)  0*ones(1,41)    3*pi/4*ones(1,10)   0*ones(1,65)     -pi*ones(1,10)     0*ones(1,30)   -pi/2*ones(1,10)     0*ones(1,15)   -pi/2*ones(1,10)  0*ones(1,25)   -pi*ones(1,10)  0*ones(1,25)   -pi/2*ones(1,10)     0*ones(1,15)   -pi/2*ones(1,10)  0*ones(1,31)]; % Velocidad angular de referencia (m/s)
